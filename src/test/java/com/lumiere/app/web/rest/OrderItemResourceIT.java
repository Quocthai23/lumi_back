...
import static com.lumiere.app.domain.OrderItemAsserts.*;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity() {
        return new OrderItem().quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE).totalPrice(DEFAULT_TOTAL_PRICE);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).totalPrice(UPDATED_TOTAL_PRICE);
    }
