...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_TYPE = NotificationType.ORDER_UPDATE;
    private static final NotificationType UPDATED_TYPE = NotificationType.NEW_ANSWER;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).link(UPDATED_LINK);
