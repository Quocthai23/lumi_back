...
/**
 * Criteria class for the {@link com.lumiere.app.domain.Warehouse} entity. This class is used
 * in {@link com.lumiere.app.web.rest.WarehouseResource} to receive all the possible filtering options from
...
public class WarehouseCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, address, isActive, distinct);
    }
