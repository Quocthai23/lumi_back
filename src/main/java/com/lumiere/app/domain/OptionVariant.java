...
public class OptionVariant implements Serializable {
    ...
    @JoinColumn(name = "product_variant_id", nullable = false, foreignKey = @ForeignKey(name = "fk_option_variant_variant"))
    private ProductVariant productVariant;

    /** Lựa chọn thuộc tính đã chọn */
    @NotNull
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "option_select_id", nullable = false, foreignKey = @ForeignKey(name = "fk_option_variant_select"))
