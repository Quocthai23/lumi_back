 ...
 */
@Repository
public interface CollectionRepository extends CollectionRepositoryWithBagRelationships, JpaRepository<Collection, Long> {
    default Optional<Collection> findOneWithEagerRelationships(Long id) {
